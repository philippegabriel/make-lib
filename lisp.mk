...
arg2=$(call getarg2,$(1))
display=display:$(1)
append=$(call seval,(cond ((null $(arg1)) $(arg2)) ((quote t) (cons (car $(arg1)) (append (cdr $(arg1))$(arg2))))))
assoc=$(call seval,(cond ((eq (caar $(arg2)) $(arg1)) (cadar $(arg2))) ((quote t) (assoc $(arg1) (cdr $(arg2))))))
#
#eval function
#
x=$(call getarg1,$(1))
